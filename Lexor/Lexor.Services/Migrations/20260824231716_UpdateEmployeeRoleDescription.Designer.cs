...
namespace Lexor.Services.Migrations
{
    ...
    [Migration("20260824231716_UpdateEmployeeRoleDescription")]
    partial class UpdateEmployeeRoleDescription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lexor.Services.Database.Attendance", b =>
                {
                    ...
                    b.Property<int>("DepartureEditCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lexor.Services.Database.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Računovodstvo - obračun plata i platni izvještaji",
                            IsActive = true,
                            Name = "Accounting"
                        },
                        new
            ...
            modelBuilder.Entity("Lexor.Services.Database.User", b =>
                {
                    ...
                    b.Property<string>("PasswordResetCodeSalt")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ProfileThumbnailBase64")
                        .HasColumnType("nvarchar(max)");
