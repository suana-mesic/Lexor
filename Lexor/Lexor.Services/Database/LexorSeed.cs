    ...
    public partial class LexorDbContext
    {
        private void CreateSeed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(
                new Role { Id = 1, Name = RoleNames.HrManager,     Description = "HR menadžer - uposlenici, odsustva, izvještaji, detekcija prevara", CreatedAt = seedDate, IsActive = true },
                new Role { Id = 2, Name = RoleNames.Employee,      Description = "Uposlenik - pristup mobilnoj aplikaciji", CreatedAt = seedDate, IsActive = true },
